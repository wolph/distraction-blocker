    ...
    >
      ...
      {local ? (
        <p>
          ...
          completes, the instructions it sent to those tabs. A record of each tab that confirmed an
          instruction keeps that tab's address until Focus Lock's data is deleted as a whole.
        </p>
      ) : (
        <p>
