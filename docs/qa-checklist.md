...
- Portable evidence instructions and verifier: `docs/qa-artifacts/onboarding-task6/README.md` and `docs/qa-artifacts/onboarding-task6/verify.mjs`. Run `node docs/qa-artifacts/onboarding-task6/verify.mjs` on macOS or Linux.
