...
The same page can also delete all Focus Lock data. Delete all Focus Lock data removes every Focus Lock record from this device and, when sync is on, the synced copies from Chrome Sync, ends a running session, and returns the extension to setup.
